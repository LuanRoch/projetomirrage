...
const Hero = () => {
  const backgroundImage = "/image/MicaeleAgata.png"; // Altere para o caminho da imagem
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-6 space-y-6 text-white">
        ...
        <p className="text-lg sm:text-xl leading-relaxed">
          Olá, familiares e amigos! Estamos muito felizes em compartilhar este
          momento tão especial das nossas vidas com vocês. A presença de todos
          no nosso grande dia já é o maior presente, mas criamos uma lista de
          serviços simbólicos que representam os sonhos e planos que queremos
          realizar juntos.
        </p>
        <p className="text-lg sm:text-xl leading-relaxed">
